...
<head>
<meta charset="utf-8">
<title>Fundación Crystal - RUT Responder Comentarios</title>
...
<form action="ver_insertar_respuesta_nl.php" method="post" name="insertar_comentario">
    <table>
        <tr>
        ...
        <tr>
            <td colspan="2" style='border:#000 1px solid;'><input type="hidden" name="pagina" value="<?php echo "$pagina"; ?>"><input type="hidden" name="articulo_titulo" value="<?php echo "$articulo"; ?>"><input type="hidden" name="nombre_comentarista" value="<?php echo "$nombre_comentarista"; ?>"><input type="submit" name="enviar" value="Responder"></td>
        </tr>
	</table>
</form>
</section>
