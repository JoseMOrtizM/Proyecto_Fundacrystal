...
//RESCATANDO EL RESTO DE LOS DATOS DEL FORMULARIO
$nombre=$_POST['nombre'];
...
if($contrasena1==$contrasena2){$ver_contrasena="ok";}else{$ver_contrasena="error";}
//ACTUALIZANDO BD
if($ver_img_type=='ok' and $ver_img_size=='ok' and $ver_contrasena=="ok"){
	$consulta="UPDATE `datos_usuarios` SET
				NOMBRE='$nombre',
				APELLIDO='$apellido',
				F_NACIMIENTO='$f_nac',
				AUTOR_CORREO='$correo',
...
<section>
	...
	<form action="update_user.php" method="post" name="modificar">
    <table>
    	<tr>
        	<th colspan="4" style="border:1px solid #333;"><h3 style="text-align:center;">
			<?php
            if($ver_img_type=='error'){echo "ERROR: Foto con formato inválido<br>";}
            if($ver_img_size=='error'){echo "ERROR: Foto con tamaño inválido<br>";}
            if($ver_contrasena=="error"){echo "ERROR: contraseña inválida<br>";}
            if($ver_img_type=='ok' and $ver_img_size=='ok' and $ver_contrasena=="ok"){echo "Los datos se actualizaron con éxito";}
            ?>
            </h3></th>
        </tr>
    	<tr>
        	...
        	<td style="border:1px solid #333;"><input type="text" style="width:175px; background-color:#ffffee;" name="nombre" required value="<?php echo "$apellido"; ?>"></td>
        </tr>
    	<tr>
        	<th style="border:1px solid #333;">Fecha Nacimiento:</th>
        	<td style="border:1px solid #333;"><input type="text" style="width:175px; background-color:#ffffee;" name="nombre" required value="<?php echo "$f_nac"; ?>"></td>
        	<th style="border:1px solid #333;">Correo:</th>
        	<td style="border:1px solid #333;"><input type="text" style="width:175px; background-color:#ffffee;" name="nombre" required value="<?php echo "$correo"; ?>"></td>
        </tr>
    	<tr>
        	<th style="border:1px solid #333;">País:</th>
        	<td style="border:1px solid #333;">
                <select style="width:180px; font-size:12px; background-color:#ffffee;" type="text" name="nacionalidad" id="nacionalidad">
        	...
        	<td style="border:1px solid #333;"><input type="text" style="width:175px; background-color:#ffffee;" name="nombre" value="<?php echo "$facebook"; ?>"></td>
        </tr>
    	<tr>
        	<th style="border:1px solid #333;">Twitter:</th>
        	<td style="border:1px solid #333;"><input type="text" style="width:175px; background-color:#ffffee;" name="nombre" value="<?php echo "$twitter"; ?>"></td>
        	<th style="border:1px solid #333;">Instagram:</th>
        	<td style="border:1px solid #333;"><input type="text" style="width:175px; background-color:#ffffee;" name="nombre" value="<?php echo "$instagram"; ?>"></td>
        </tr>
    	<tr>
        	<th style="border:1px solid #333;">Pregunta:</th>
        	<td style="border:1px solid #333;">
                <select style="width:180px; background-color:#ffffee;" type="text" name="pregunta" id="pregunta">
        	...
        	<td style="border:1px solid #333;"><input type="text" style="width:175px; background-color:#ffffee;" name="nombre" required value="<?php echo "$respuesta"; ?>"></td>
        </tr>
    	<tr>
        	<th style="border:1px solid #333;">Contraseña:</th>
        	<td style="border:1px solid #333;"><input type="text" style="width:175px; background-color:#ffffee;" name="nombre" required value="<?php echo "$contrasena1"; ?>"></td>
        	<th style="border:1px solid #333;">Rep. Cont.:</th>
        	<td style="border:1px solid #333;"><input type="text" style="width:175px; background-color:#ffffee;" name="nombre" required value="<?php echo "$contrasena2"; ?>"></td>
        </tr>
    	<tr>
        	<th style="border:1px solid #333;">Descripción:</th>
        	<td colspan="2" style="border:1px solid #333;"><textarea rows="4" style="width:95%; background-color:#ffffee;"><?php echo "$descrip"; ?></textarea required></td>
            <td style="border:1px solid #333;"><a href="zona_adm.php">Volver a la Zona Principal</a></td>
        </tr>
