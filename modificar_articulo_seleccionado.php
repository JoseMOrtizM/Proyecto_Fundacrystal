...
if($_GET['titulo_articulo']==true){$titulo_articulo=$_GET['titulo_articulo'];}else{
...
<head>
<meta charset="utf-8">
<title>Fundación Crystal - Modificar Articulo Seleccionado</title>
...
?>
<section>
<form action="update_articulo.php" method="post" enctype="multipart/form-data">
